                    ...
                    this.$modal.show(
                        {
                            template: `
                              <div class="p-4">
                                <h1 class="text-center text-3xl font-extrabold text-gray-900">Successful login</h1>
                                <p class="overflow-auto bg-indigo-200 p-4 mt-2 whitespace-nowrap rounded" ref="token">{{ text }}</p>
                              </div>
                            `,
                            props: ['text']
                        },
